...
export const DecorativeImage = ({ className, src, alt, text, back }: DecorativeImageProps): JSX.Element => {
  return (
    <>
      {!back ?
        <div className={twMerge("relative flex flex-col items-center justify-center rounded-lg max-w-[75px] max-h-[75px] sm:max-w-[100px] sm:max-h-[100px] transition-all duration-500 bg-white shadow-sm ", className)} >
          <Image
