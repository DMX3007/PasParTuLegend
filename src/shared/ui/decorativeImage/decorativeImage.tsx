...
export const DecorativeImage = ({ className, src, alt, text, back }: DecorativeImageProps): JSX.Element => {
  return (
    <>
      {!back ?
        <div className={twMerge("flex flex-col items-center justify-center rounded-lg min-w-[65px] min-h-[65px] max-w-[75px] max-h-[75px] sm:max-w-[75px] sm:max-h-[75px] sm:min-w-[75px] sm:min-h-[85px] md:min-w-[125px] md:min-h-[125px] transition-all duration-500 bg-white shadow-sm", className)} >
          <div className="flex flex-col items-center max-w-[43px] max-h-[70px] sm:max-w-[55px] md:max-w-[95px] md:max-h-[110px]">
            <Image
