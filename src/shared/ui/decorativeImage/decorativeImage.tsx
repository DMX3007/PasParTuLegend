...
import { comfortaa } from "@/shared/assets/fonts/fonts";
...
export const DecorativeImage = ({ className, src, alt, text, back }: DecorativeImageProps): JSX.Element => {
  return (
    <>
      {!back ?
        <div className={twMerge("flex flex-col items-center justify-center rounded-lg min-w-[65px] min-h-[65px] max-w-[75px] max-h-[75px] mob:max-w-[75px] mob:max-h-[75px] mob:min-w-[75px] mob:min-h-[85px] md:min-w-[125px] md:min-h-[125px] lg:min-w-[145px] lg:min-h-[155px] transition-all duration-500 bg-white shadow-sm", className)} >
        ...
        <div className={twMerge("flex flex-col items-center justify-center", className)}>
          ...
          <span className="
relative after:bg-[#773d06] after:absolute after:h-0.5 after:w-0 after:bottom-0 after:left-0 group-hover:after:w-full after:transition-all after:duration-300 cursor-pointer
">
            {text}
          </span>
            </p >
